...
public abstract class Log {
	...
	static void init() {
		if (defaultLogFactory == null) {
			defaultLogFactory = newDefaultLogFactory("org.apache.log4j.Logger", "com.jfinal.log.Log4jLogFactory");
		}
		if (defaultLogFactory == null) {
			defaultLogFactory = newDefaultLogFactory("org.apache.logging.log4j.Logger", "com.jfinal.log.Log4j2LogFactory");
		}
		if (defaultLogFactory == null) {
